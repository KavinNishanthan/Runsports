        ...
        <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <ul className="mt-8 space-y-2">
              ...
              <li className="flex items-center text-left text-sm font-medium text-gray-600">{`Size : ${(
                <ul>{item && item.sizes.map((size, index) => <li key={index}>{size.label}</li>)}</ul>
              )}`}</li>
            </ul>
            <div className="lg:col-span-3">
              ...
              <div className="mr-4 mt-8 flow-root sm:mt-12">{item && item.description}</div>
            </div>
          </div>
        </div>
      </div>
